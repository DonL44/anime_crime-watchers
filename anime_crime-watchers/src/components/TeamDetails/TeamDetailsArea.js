                     ...
                     <div className="teacher__wrapper">
                        <div className="teacher__top d-md-flex align-items-end justify-content-between">
                           <div className="teacher__info">
                              ...
                              <span>Developer {singleTeam?.teaches}</span>
                           </div>
                        ...
                        <div className="teacher__courses pt-55">
                           <div className="section__title-wrapper mb-30">
                              <h2 className="section__title">Developer <span className="yellow-bg yellow-bg-big">Tools<img src="assets/img/shape/yellow-bg.png" alt="" /></span></h2>
                           </div>
