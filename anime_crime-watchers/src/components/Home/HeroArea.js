                              ...
                              <div className="row">
                                 ...
                                 <div className="col-xxl-7 col-xl-8 col-lg-8 col-md-10 col-sm-10">
                                    <div className="slider__content p-relative z-index-1">
                                       {/* <span >Hanzai Watchers</span> */}
                                       <h2 className="slider__title">{slider.title}</h2>
                                       <p>We believe everyone should have the opportunity to submit a crime tip, be safe, and become a hero for society.</p>
                                       <div className="slider__btn">
                                          <Link href="/courses">
                                             <a className="tp-btn">Find </a>
                                          </Link>
                                       </div>
                                    </div>
                                 </div>
