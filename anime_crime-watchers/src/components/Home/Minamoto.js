                  ...
                  <div className="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                     <div className="campus__wrapper">
                        <div className="section__title-wrapper mb-25">
                           <span className="section__title-pre">Our Hero</span>
                           <h2 className="section__title section__title-40">Minamoto no Yoshitsune</h2>
                           <p>Our Hanzai Watchers app has an impact globally by providing society safety through samurais and FBI APIs</p>
                        </div>
