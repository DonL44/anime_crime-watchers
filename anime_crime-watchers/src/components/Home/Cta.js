                  ...
                  <div className="row">
                     <div className="col-xxl-6 col-xl-6 col-lg-6">
                        <div className="cta__item cta__item-border pt-40 pb-15 d-sm-flex align-items-start pr-110">
                           ...
                           <div className="cta__content">
                              <h3 className="cta__title">See repo</h3>
                              <p>To collaborate in this startup, please see our GitHub repository.</p>
                              <Link href="/contact">
                                 <a className="tp-btn tp-btn-3">Github</a>
                              </Link>
                           </div>
                        </div>
                     </div>
                     <div className="col-xxl-6 col-xl-6 col-lg-6">
                        <div className="cta__item pl-85 pt-40 pb-15 d-sm-flex align-items-start">
                           ...
                           <div className="cta__content">
                              <h3 className="cta__title">To hire a developer</h3>
                              <p>Need a developer? Then we are here for you!</p>
                              <Link href="/contact">
                                 <a className="tp-btn tp-btn-4">Hire a developer</a>
                              </Link>
                           </div>
                        </div>
                     </div>
